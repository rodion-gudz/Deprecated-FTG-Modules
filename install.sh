...
# shellcheck disable=SC2086
runin ${SUDO_CMD}"python$PYVER" -m pip install -r https://raw.githubusercontent.com/fast-geek/FTG-modules/main/requirements.txt --user --no-warn-script-location --disable-pip-version-check || { errorin "Requirements failed!"; exit 4; }
